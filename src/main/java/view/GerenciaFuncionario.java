...
/**
 * Tela de gerenciamento de funcionários cadastrados no sistema.
 * <p>Disponibiliza uma tabela com os registros e botões para alteração ou exclusão.</p>
 */
public class GerenciaFuncionario extends javax.swing.JFrame {

    /**
     * Cria a janela de gerenciamento e carrega a tabela com os funcionários existentes.
     */
    ...
    /**
     * Método gerado pela IDE para configurar os componentes gráficos da tela.
    ...
    /**
     * Fecha a janela de gerenciamento de funcionários.
     *
    ...
    /**
     * Processa a alteração dos dados do funcionário selecionado na tabela.
     *
    ...
    /**
     * Preenche os campos do formulário com os dados do funcionário selecionado.
     *
     * @param evt evento de clique na tabela de funcionários
     */
    ...
    /**
     * Remove o funcionário selecionado após confirmação.
     *
    ...
    /**
     * Evento disparado ao interagir com o campo de CPF (sem ação adicional).
     *
     * @param evt evento associado ao campo de CPF
     */
    ...
    /**
     * Atualiza a tabela com os dados atuais dos funcionários cadastrados.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Exibe a tela de gerenciamento de funcionários de forma independente.
     *
